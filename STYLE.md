...
- Dashes: sparingly, spaced (" — "), at most one per paragraph. Never a bare hyphen as a dash.
...
semicolons in Bangla text, Latin-script English words mid-sentence, Devanagari characters,
এবং/এটি/গুরুত্বপূর্ণ/-ভাবে density, and English digits in Bangla prose. The linter is
advisory — it catches the mechanical tells; the read-aloud test catches the rest.
