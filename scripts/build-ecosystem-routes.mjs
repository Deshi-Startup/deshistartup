...
const routes = [
  ...
  { route: 'startup-ideas/review', component: 'ConnectionReview', en: ['Review company connections', 'Private review queue for Deshi Startup reviewers.'], bn: ['কোম্পানির তথ্য পর্যালোচনা', 'Deshi Startup-এর পর্যালোচকদের জন্য জমা দেওয়া তথ্য।'] },
