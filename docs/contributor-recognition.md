...
- `profiles`: stable ID and ASCII slug, public display fields, optional confirmed organization,
  public links, avatar/monogram choice, proof-card choice, confirmation date, and visibility.
...
4. Add or update the ledger entry. Add identity aliases only in
   `data/contributors-policy.json`; core-team membership and opt-outs also stay there.
