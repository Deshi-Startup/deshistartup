...
1. **ফিডব্যাক দিন:** পাতার **ফিডব্যাক দিন** অপশনে কোন তথ্যটি ভুল বা অস্পষ্ট, তা লিখুন।
   সঠিক তথ্য বা সরকারি সূত্র জানা থাকলে সঙ্গে দিন। রিপোর্ট পাঠাতে GitHub-এ সাইন ইন
   করতে হতে পারে।
2. **ছোট পরিবর্তন করুন:** পাতার **এডিট** বাটন চাপুন, Google দিয়ে সাইন ইন করুন,
...
GitHub ব্যবহার করতে চাইলে পাতার নিচের **GitHub-এ এডিট করুন** লিংকও ব্যবহার করতে পারেন।

## পূর্ণ গাইড লেখার ধাপ

1. **বিষয়টি নিন।** [লেখা বাকি বিষয়](https://deshistartup.com/guides) থেকে একটি
   বেছে নিন। ওই বিষয়ের ইস্যু থাকলে সেখানে জানান যে আপনি লিখছেন।
2. **মূল সূত্র খুঁজুন।** আইন, কর, ফি, রেজিস্ট্রেশন ও সরকারি প্রক্রিয়ার জন্য সরকারি
...
[/start-here](https://deshistartup.com/start-here) একটি পূর্ণ গাইডের ভালো নমুনা।

## ছবি পাঠালে

সম্পাদক থেকে PNG, JPEG বা WebP ছবি পাঠানো যায়। প্রকাশের আগে ছবিটি ব্যক্তিগত
কোয়ারেন্টাইনে থাকে। একজন অনুমোদিত রিভিউয়ার আলাদা করে ছবিটি না দেখা পর্যন্ত সেটি
প্রকাশ হয় না।
...
অযথা ঝুঁকি তৈরি হচ্ছে কি না এবং লেখা বা ছবিতে কপিরাইটের সমস্যা আছে কি না। আইন, কর,
...
অবদান পাঠালে কনটেন্টের জন্য [CC BY-SA ৪.০](./LICENSE-content.md) এবং কোডের জন্য
[MIT](./LICENSE) লাইসেন্সে প্রকাশে সম্মতি দিচ্ছেন। কেবল নিজের লেখা বা ব্যবহার ও
পুনঃপ্রকাশের অনুমতি আছে এমন উপাদান পাঠান।
...
1. **Report a problem:** use **Report a mistake** on the page and describe what is wrong or
   ...
   you to sign in before submitting the report.
...
1. **Claim the topic.** Choose one from the [unwritten topics](https://deshistartup.com/en/guides)
   and leave a note on its issue if one exists.
2. **Find primary sources.** Start with official documents for legal, tax, fee, registration and
...
The browser editor accepts PNG, JPEG and WebP images. A pending image stays private until an
authorized reviewer approves it separately.
...
code under [MIT](./LICENSE). Submit only work you wrote or have permission to use and republish.
