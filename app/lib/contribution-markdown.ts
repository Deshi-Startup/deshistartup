...
const LOCKED_COMPONENT = /<([A-Z][\w]*)\b[^>]*?\/>|<\/?(CaseTimeline|CaseMilestone|CaseDetail|CaseProcess|CaseExchange|CaseContrast|ToolsResourceGroups|ToolsResourceGroup|RoadmapPath|RoadmapStage|JourneySteps)\b[^>]*>/g
