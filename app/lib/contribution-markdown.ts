...
const LOCKED_COMPONENT = /<([A-Z][\w]*)\b[^>]*?\/>|<\/?(CaseTimeline|CaseMilestone|CaseDetail|CaseProcess|CaseExchange|CaseCashCycle|CaseLearningEvidence|CaseAgentLiquidity|CaseGroupedDelivery|CaseContrast|ToolsResourceGroups|ToolsResourceGroup|RoadmapPath|RoadmapStage|JourneySteps)\b[^>]*>/g
