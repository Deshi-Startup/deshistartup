...
const bn: TranslationStrings = {
  ...
  lead2:
    'বাংলাদেশের বাস্তবতা অন্যান্য দেশের চেয়ে আলাদা। কাস্টমারের ভরসা পেতে সময় লাগে, ক্যাশ অন ডেলিভারি এখনো জরুরি, ফেসবুক/মেসেঞ্জার বা মেসেজিং অ্যাপ বড় বিক্রির চ্যানেল। সরকারি কাগজপত্রও বুঝে করতে হয়। তাই এই সাইটে আমরা সরাসরি বিদেশি পরামর্শ কপি না করে বরং বাংলাদেশে কীভাবে কাজ হয়, সেটা ব্যাখ্যা করার চেষ্টা করি।',
  start: [
  ...
  stageSub:
    'সবাই একই জায়গা থেকে শুরু করেন না। কেউ আইডিয়া পর্যায়ে, কেউ ফেসবুক পেজ খুলে ফেলেছেন, কেউ রেজিস্ট্রেশন নিয়ে আটকে আছেন। নিজের অবস্থার ঘরটা বেছে নিন, না হয় ওপরের সার্চে প্রশ্নটা লিখে ফেলুন।',
  stages: [
  ...
  topics: [
    ...
    ['সব বিষয়', 'রেজিস্ট্রেশন থেকে খাতভিত্তিক গাইড – প্রতিটি বিভাগের হাব এক পাতায়', '/guides']
  ],
  ...
  faq: [
    ['শুরুতেই কি কোম্পানি খুলতে হবে?', 'সবসময় না। অনেক সময় আগে বরং কাস্টমারের চাহিদা যাচাই, পেমেন্ট নেওয়ার সহজ একটা পথ আর গোড়ার হিসাবটা বেশি জরুরি। বিস্তারিত আইনি রোডম্যাপ গাইডে।'],
    ...
    ['এই লেখাগুলো কারা লেখে?', 'কমিউনিটি: ফাউন্ডার, ছাত্র, পেশাজীবী। প্রতিটি পাতার “এডিট” অপশন থেকে যে কেউ ভুল ঠিক করতে বা নতুন লেখা যোগ করতে পারেন। রিভিউয়াররা যাচাই করে যুক্ত করেন।']
  ],
