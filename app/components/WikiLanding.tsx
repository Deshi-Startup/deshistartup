...
const bn: TranslationStrings = {
  ...
  stageSub:
    'সবাই একই জায়গা থেকে শুরু করেন না। কেউ আইডিয়া পর্যায়ে, কেউ ফেসবুক পেজ খুলে ফেলেছেন, কেউ নিবন্ধন নিয়ে আটকে আছেন। নিজের অবস্থার ঘরটা বেছে নিন, না হয় ওপরের সার্চে প্রশ্নটা লিখে ফেলুন।',
  stages: [
  ...
  govSub: 'নিবন্ধন, কর, ভ্যাট বা ব্যাংকিং নিয়ে কাজ করার সময় সরকারি পোর্টাল দেখে শেষ সিদ্ধান্ত নিন। নতুন উদ্যোক্তা হলে এই লিংকগুলোতে বারবার ফিরতে হবে।',
  gov: [
