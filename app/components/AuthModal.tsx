...
interface AuthModalProps {
  ...
  isEn?: boolean
  fallbackHref?: string
  purpose?: 'editing' | 'ecosystem' | 'voting' | 'review'
}
...
export default function AuthModal({
  ...
  const errorMessage =
    error === 'no_client_id'
      ? t(
          purpose !== 'editing' ? 'Google সাইন-ইন এখন পাওয়া যাচ্ছে না। পরে আবার চেষ্টা করুন।' : 'এই সাইটে Google সাইন-ইন এখন পাওয়া যাচ্ছে না। আপাতত GitHub-এ এডিট করতে পারেন।',
          purpose !== 'editing' ? 'Google sign-in is unavailable. Try again later.' : 'Google sign-in is not available right now. You can edit on GitHub instead.'
        )
    ...
    >
      <div className="modal-card" ref={dialogRef} tabIndex={-1}>
        ...
        <p className="modal-lede" id={descriptionId}>
          {purpose === 'review' ? t('পর্যালোচনার জন্য অনুমোদিত অ্যাকাউন্ট দিয়ে সাইন ইন করুন।', 'Sign in with your reviewer account.') : purpose === 'voting' ? t('যে আইডিয়াটি বাস্তবে দেখতে চান, তাতে ভোট দিন।', 'Vote for an idea you’d like to see built.') : purpose === 'ecosystem' ? t('তথ্য জমা দিতে বা নিজের জমা দেওয়া তথ্য দেখতে সাইন ইন করুন।', 'Sign in to submit information or view your contributions.') : t(
        ...
        {purpose !== 'review' && <p className="modal-note">
