...
export default function AuthModal({
  ...
  const errorMessage =
    error === 'no_client_id'
      ? t(
          purpose === 'ecosystem' ? 'Google সাইন-ইন এখন পাওয়া যাচ্ছে না। খসড়া রেখে পরে চেষ্টা করুন।' : 'এই সাইটে Google সাইন-ইন এখন পাওয়া যাচ্ছে না। আপাতত GitHub-এ এডিট করতে পারেন।',
          purpose === 'ecosystem' ? 'Google sign-in is unavailable. Keep your draft and try again later.' : 'Google sign-in is not available right now. You can edit on GitHub instead.'
        )
    ...
    >
      <div className="modal-card" ref={dialogRef} tabIndex={-1}>
        ...
        <p className="modal-lede" id={descriptionId}>
          {purpose === 'ecosystem' ? t('তথ্য জমা দিতে বা নিজের জমা দেওয়া তথ্য দেখতে সাইন ইন করুন।', 'Sign in to submit information or view your contributions.') : t(
        ...
        <p className="modal-note">
          {purpose === 'ecosystem' ? t('জমা দেওয়া তথ্য পর্যালোচনা ও প্রকাশের আগে অন্যরা দেখতে পাবেন না।', 'Submissions stay private until reviewed and published.') : t(
