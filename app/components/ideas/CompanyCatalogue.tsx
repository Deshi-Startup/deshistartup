...
export default function CompanyCatalogue({locale, companies, sectors}: {locale:Locale; companies:CompanySummary[]; sectors:{id:string;label:string}[]}) {
  ...
  return <IdeaShell locale={locale}><div className="companies-directory">
    <div className="companies-intro"><h1>{en?'Companies':'কোম্পানি'}</h1><p>{en?'Browse startup companies and investors in Bangladesh. Find what they build, who is involved and the sources behind each profile.':'বাংলাদেশের স্টার্টআপ কোম্পানি ও বিনিয়োগকারীদের সম্পর্কে জানুন। তারা কী তৈরি করে, কারা যুক্ত আছেন আর প্রতিটি প্রোফাইলের তথ্য কোথা থেকে এসেছে, দেখে নিন।'}</p></div>
