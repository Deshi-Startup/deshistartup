...
export function useEcosystemSession(locale: Locale, options: { purpose?: 'ecosystem' | 'voting'; onAuthenticated?: (auth: AuthState) => void; onDismiss?: () => void } = {}) {
...
export function ecosystemError(status: number, locale: Locale) {
  const messages: Record<number, [string, string]> = {
    ...
    409: ['This information has changed or the company is already listed for this problem. Refresh the list and check before trying again.', 'তথ্য বদলেছে বা এই যোগসূত্র আগে থেকেই আছে। তালিকা রিফ্রেশ করে কোম্পানির তথ্য দেখুন।'],
