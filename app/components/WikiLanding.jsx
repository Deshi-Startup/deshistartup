...
const bn = {
  ...
  stages: [
    ...
    ['ব্যবসা চালু করতে চাই', 'ট্রেড লাইসেন্স, কোম্পানি, টিআইএন, ভ্যাট, ব্যাংক – কোন কাগজ কখন লাগে, ধাপে ধাপে।', 'আইনি পথ দেখুন', '/legal-roadmap'],
  ...
  faq: [
    ['শুরুতেই কি কোম্পানি খুলতে হবে?', 'সবসময় না। অনেক ক্ষেত্রে আগে গ্রাহকের চাহিদা যাচাই করা, পেমেন্ট নেওয়ার সহজ পথ ঠিক করা এবং প্রাথমিক হিসাব রাখা বেশি জরুরি। বিস্তারিত আইনি রোডম্যাপ গাইডে।'],
